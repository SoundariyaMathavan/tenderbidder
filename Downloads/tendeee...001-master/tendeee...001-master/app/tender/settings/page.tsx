                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Get notified when new bids are submitted
                      </p>
                    </div>
                    <Switch
                      checked={notifications.bidSubmissions}
                      onCheckedChange={(checked) =>
                        setNotifications({ ...notifications, bidSubmissions: checked })
                      }
                    />
                  </div>
                  <div className="flex items-center justify-between">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Be notified about project status changes
                      </p>
                    </div>
                    <Switch
